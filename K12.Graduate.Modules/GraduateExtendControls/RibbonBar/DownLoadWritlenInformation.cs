...
{
    public partial class DownLoadWritlenInformation : BaseForm
    {
        /// <summary>
        /// 背景模式
        /// </summary>
        ...
        public DownLoadWritlenInformation()
        {
            InitializeComponent();
        }

        private void DownLoadWritlenInFormation_Load(object sender, EventArgs e)
        {
        ...
        void BGW_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (FileName == "*") //當FileName是*時,下載所有學生之書面資料
            {
                ...
                List<WrittenInformationUDT> WrList = _AccessHelper.Select<WrittenInformationUDT>(UDT_S.PopOneCondition("RefUDT_ID", KeyList));

                foreach (WrittenInformationUDT each in WrList)
                {
            ...
            else
            {
                ...
                T.Start();
                List<WrittenInformationUDT> WrList = _AccessHelper.Select<WrittenInformationUDT>(UDT_S.PopTwoCondition("RefUDT_ID", FileName, KeyList));
        ...
        /// 儲存檔案
        /// </summary>
        private void SaveValue(string SelectPath, GraduateUDT value1, WrittenInformationUDT value2)
        {
            //讀取資料
